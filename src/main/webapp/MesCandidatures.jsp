            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-2">
							<div class="col-sm-4">
							    <a href="PostulerOffre.jsp" class="btn btn-primary rounded-pill mb-3">Créer une candidature</a>
							</div>
						        ...
						        <table class="table table-bordered table-centered mb-0">
						            ...
						            <c:forEach items="${candidatures}" var="candidature">
						                ...
						                <tr>
						                    ...
						                    <td>
						                   <div class="col-sm-4">
											    <a href="offreServlet?action=ajout" class="btn btn-success rounded-pill mb-3"> Modifier</a>
											</div>
 											<td>
											    <div class="col-sm-4">
													<a href="servletCandidature?action=supprimerCandidature&id=${candidature.id}" class="btn btn-danger rounded-pill mb-3">Supprimer</a>
											    </div>
											</td>
