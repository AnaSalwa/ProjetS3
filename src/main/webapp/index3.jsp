...
<html lang="en">
  ...
  <!-- Inclure la feuille de style de Material Design Icons -->
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarProjects">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="apps-projects-add.html">Créer une offre d'emploi</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">modifier l'offre d'emploi</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Modifier l'offre d'emploi</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
   ...
   <form action="offreServlet?action=editer" method="post">
    <div class="row">
        <div class="col-md-6">
            <input type="hidden" name="id" value="${offre.id}" />
            <div class="mb-3">
                <label for="titre" class="form-label">Poste :</label>
               <input type="text" name="titre" class="form-control" value="${offre.titre}" placeholder="Entrez le titre de l'offre d'emploi.." />
            </div>

          <div class="mb-3">
    <label for="poste" class="form-label">Description :</label>
    <textarea class="form-control" name="poste" rows="5">${offre.poste}</textarea>
</div>


            <div class="mb-3">
                <label for="date" class="form-label">Date de l'ajout :</label>
                <input type="text" name="date" class="form-control" value="${offre.date}" data-provide="datepicker" data-date-container="#datepicker1" data-date-format="d-M-yyyy" data-date-autoclose="true">
            </div>
        ...
        <div class="col-md-6"><br><br>
            <div class="mb-3 mt-3 mt-md-0">
                <!-- Balise pour l'image -->
                <img src="images/joo.jpg" alt="Votre image" class="img-fluid">
            </div>
        </div> <!-- end col -->
    </div> <!-- end row -->
    <div class="mb-3"> <br>
        <input type="submit" value="Modifier" class="btn btn-success rounded-pill mb-3">
        <a href="offreServlet" class="btn btn-danger rounded-pill mb-3">Retour</a>
    </div>
</form>
