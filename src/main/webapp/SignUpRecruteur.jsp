...
<head>
    ...
    <!-- App css -->
    <link href="Css/SignUpRecruteur1.css" rel="stylesheet" type="text/css" id="app-style" />
    <link href="Css/SignUpRecruteur2.css" rel="stylesheet" type="text/css" id="app-style" />
        ...
        <div class="auth-fluid-form-box">
            <div class="card-body d-flex flex-column h-100 gap-3">
                ...
                <div class="my-auto">
    				...
    				<form action="servletRecruteur?action=insert" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="prenom"  name="prenom"  placeholder="Entrer votre prénom" required>
                        </div>
                         <div class="mb-3">
                            <label for="entreprise" class="form-label">Entreprise</label>
                            <input class="form-control" type="text" id="entreprise"  name="entreprise"   placeholder="Entrer le nom de votre entreprise" required>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Adresse email</label>
                            <input class="form-control" type="email" id="email"   name="email" required placeholder="Entrer votre adresse email">
                        </div>
                        <div class="mb-3">
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Already have account? <a href="LoginChoice.jsp" class="text-muted ms-1"><b>Log In</b></a></p>
                </footer>
