...
<html lang="en">
    ...
    <head>
        ...
        <!-- App css -->
        <link href="Css/Landing1.css" rel="stylesheet" type="text/css" id="app-style" />

        <!-- Icons css -->
        <link href="Css/Landing2.css" rel="stylesheet" type="text/css" />        
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav me-auto align-items-center">
                        ...
                        <li class="nav-item mx-lg-1">
                            <a class="nav-link" href="LoginChoice.jsp">Log in</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-0">
                            <a href="SignUpChoice.jsp" target="_blank" class="nav-link d-lg-none">Sign up now</a>
                            <a href="SignUpChoice.jsp" target="_blank" class="btn btn-sm btn-light rounded-pill d-none d-lg-inline-flex">
                                <i class="mdi mdi-basket me-2"></i> Sign Up Now
                            </a>
                        </li>
                    </ul>
