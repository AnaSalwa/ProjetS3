...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Détails sur l'offre d'emploi | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <!-- App css -->
        <link href="css/css1.css" rel="stylesheet" type="text/css" id="app-style" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <form class="ps-lg-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="d-flex">
                                                        <a href="offreServlet?id=${offre.id}&action=edit" class="btn btn-warning ms-2"><i class="mdi mdi-cart me-1"></i>Modifier</a>

                                                       <a href="offreServlet?id=${offre.id}&action=supprimer" class="btn btn-danger ms-2"><i class="mdi mdi-cart me-1"></i>Supprimer l'offre</a>
                                                        </div>
                                                    </div>
